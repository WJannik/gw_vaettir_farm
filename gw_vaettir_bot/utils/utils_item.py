...
try:
    ...
    try:
        ...
        from gw_vaettir_bot.utils.utils_general import generate_bbox, capture_and_process_region, is_yellow, is_object
        from gw_vaettir_bot.utils.utils_general import pick_up_selected_object
