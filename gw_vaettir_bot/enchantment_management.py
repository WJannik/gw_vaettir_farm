...
class EnchantmentManager:
    ...
    def reset_enchantment_state(self):
    ...
    def handle_shadowform(self, time_passed_in_seconds):
        ...
        if ((time_passed_in_seconds - self.last_shadowform_cast_time) % SHADOWFORM_DURATION > 0.0 and 
            ...
            return True  # Enchantment was cast
    ...
    def handle_mantra_of_earth(self, time_passed_in_seconds, minimal_enchantment_maintained):
    ...
    def handle_shroud_of_distress(self, time_passed_in_seconds):
    ...
    def handle_way_of_perfection_and_master(self, time_passed_in_seconds, minimal_enchantment_maintained):
    ...
    def update_enchantments(self, time_passed_in_seconds, minimal_enchantment_maintained=False):
    ...
    def are_core_enchantments_active(self):
    ...
    def get_enchantment_states(self):
    ...
    def get_last_shadowform_cast_time(self):
